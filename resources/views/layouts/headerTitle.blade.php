<div id="header-title">
    <div class="content">
        <div id="header-title-image" class="cover bg-image">
            ...
            /asset/image/header/bg-1920.jpg 1920w" sizes="
            (max-width:400px) 400px,
            (max-width:640px) 640px,
            (max-width:720px) 720px,
            (max-width:1280px) 1280px,
            1920px" alt="رزومه عباس باقری">
        </div>
        <div class="cover bg"></div>
        <div id="particles-js" class="cover"><canvas class="particles-js-canvas-el" width="882" height="230" style="width: 100%; height: 100%;"></canvas></div>
